...
PERMISSION_CATALOG: list[tuple[str, str, str, str]] = [
    ...
    ("site_visit.view", "site_visit", "view", "View site visits."),
    ("site_visit.create", "site_visit", "create", "Schedule site visits."),
    ("site_visit.edit", "site_visit", "edit", "Edit site visits."),
    ("site_visit.delete", "site_visit", "delete", "Delete site visits."),
    ("site_visit.report", "site_visit", "report", "Submit a site visit report (may create a project)."),
